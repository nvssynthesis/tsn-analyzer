...
inline void printSettingsPath(const ArgumentList &) {
...
inline ValueTree createDefaultPresetFile() {
...
inline void printCurrentSettings(const ArgumentList &args) {
    using nvs::analysis::settingsPresetLocation;
    using nvs::analysis::systemDefaultSettingsPreset;
...
inline void createSettingsPresetFromDefault(const ArgumentList &args) {
